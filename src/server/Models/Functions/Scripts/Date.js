Date = (function (JSDate) {
  var newDate = function () {
    ...
    if (arguments.length == 0) return new JSDate();
    if (arguments.length == 1) return new JSDate(arguments[0]);
    if (arguments.length == 2) return new JSDate(arguments[0], arguments[1]);
